...
Begin
  YourIPLabel.Text := 'Your Public IP: ' + TInternetSupport.GetPublicIP;
  LocalIPLabel.Text := 'Your local IP: ' + TInternetSupport.GetLocalIP;
  LoadConfig;
End;
...
Begin
  ...
  {$IFDEF TESTNET}
  NodeList.Items.Add('http://127.0.0.1:4203');
  {$ELSE}
